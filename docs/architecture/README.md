...
| [Web app](web-app.md)                               | Folder layout of the web app, routing, data access and design system               |
| [API](api.md)                                       | Projects of the .NET solution, request pipeline, endpoints and error contract      |
