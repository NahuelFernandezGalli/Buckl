...
| [0026](0026-authenticate-with-a-development-scheme-until-auth0.md)   | Authenticate with a development scheme until Auth0 arrives              | Superseded by [0028](0028-validate-auth0-access-tokens-with-jwt-bearer.md) | 2026-09-22 |
...
| [0028](0028-validate-auth0-access-tokens-with-jwt-bearer.md)         | Validate Auth0 access tokens with JWT bearer authentication             | Accepted                                                                   | 2026-09-25 |
| [0029](0029-handle-sign-in-through-a-session-port-in-the-web-app.md) | Handle sign-in in the web app through a session port                    | Accepted                                                                   | 2026-09-25 |
| [0030](0030-keep-the-web-session-with-rotating-refresh-tokens.md)    | Keep the web session in local storage with rotating refresh tokens      | Accepted                                                                   | 2026-09-25 |
