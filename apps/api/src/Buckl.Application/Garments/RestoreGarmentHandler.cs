...
/// <summary>Puts one of the current user's archived garments back into the wardrobe.</summary>
public sealed class RestoreGarmentHandler
{
    ...
    public async Task<Garment> HandleAsync(GarmentId id, CancellationToken cancellationToken = default)
    {
        ...
        garment.Restore(_time.GetUtcNow());
